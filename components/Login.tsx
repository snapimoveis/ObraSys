...
export const Login: React.FC<LoginProps> = ({ onLogin, onNavigateToRegister }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 font-sans">
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-[450px] border border-slate-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                className={`w-full border rounded-md p-2.5 pl-10 outline-none transition-all text-sm ${
                  errors.email 
                    ? 'border-red-500 focus:ring-2 focus:ring-red-200' 
                    : 'border-slate-300 focus:ring-2 focus:ring-[#00609C] focus:border-transparent'
                }`}
              />
            </div>
            {errors.email && (
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                onChange={handleChange}
                placeholder="........"
                className={`w-full border rounded-md p-2.5 pl-10 pr-10 outline-none transition-all text-sm ${
                  errors.password
                    ? 'border-red-500 focus:ring-2 focus:ring-red-200' 
                    : 'border-slate-300 focus:ring-2 focus:ring-[#00609C] focus:border-transparent'
                }`}
          ...
          <button 
            type="submit"
            className="w-full bg-[#00609C] hover:bg-[#004e80] text-white font-bold py-3 rounded-md flex items-center justify-center gap-2 transition-colors shadow-sm"
          >
            <span>Entrar</span>
            <ArrowRight size={18} />
          </button>
